...
class WindowsWipePage extends StatefulWidget {
  const WindowsWipePage({super.key});

  @override
  State<WindowsWipePage> createState() => _WindowsWipePageState();
}

class _WindowsWipePageState extends State<WindowsWipePage> {
            ...
            children: [
              ...
              FilledButton.icon(
                onPressed: (provider.isWiping || _selectedDisk == null) ? null : () => 
                  context.read<WipeProvider>().simulateWindowsWipe(_selectedDisk!, _method),
